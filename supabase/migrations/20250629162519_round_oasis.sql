/*
  ...
  This migration adds realistic sample data for development and testing purposes.
  
  1. New Data
    - Sample user profiles with various roles
    - Property categories with descriptions and icons
    - Property listings with detailed information
    - Property media with image URLs
    - Premium plans and listings
    - Ad placements, campaigns, and advertisements
    - Reports and moderation actions
    - System settings
    
  2. Notes
    - This migration doesn't create auth.users records, only references existing ones
    - All UUIDs are deterministic for consistent references
    - Images use Pexels URLs for realistic content
*/
