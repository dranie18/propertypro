/*
  ...
  1. New Data
    - User profiles with various roles and statuses
    - Categories for property types
    - Locations (provinces, cities, districts)
    - Listings with different property types and statuses
    - Property media for listings
    - Premium listings and plans
    - Ad campaigns, placements, and advertisements
    - Reports and moderation actions
    - System settings

  2. Security
    - No changes to RLS policies
    - Sample data respects existing constraints
*/

-- Clear existing data (if needed for clean slate)
-- TRUNCATE TABLE user_profiles CASCADE;
-- TRUNCATE TABLE categories CASCADE;
-- TRUNCATE TABLE locations CASCADE;
-- TRUNCATE TABLE listings CASCADE;
-- TRUNCATE TABLE property_media CASCADE;
-- TRUNCATE TABLE premium_plans CASCADE;
-- TRUNCATE TABLE premium_listings CASCADE;
-- TRUNCATE TABLE ad_placements CASCADE;
-- TRUNCATE TABLE advertiser_accounts CASCADE;
...
-- Insert sample locations (already have UUIDs from locations.ts)
-- Provinces, cities, and districts are already defined in the locations.ts file
...
VALUES
  ('00000000-0000-4000-0000-000000000301', '00000000-0000-4000-0000-000000000103', 'Rumah Mewah 2 Lantai di Jakarta Selatan', 'Rumah mewah 2 lantai dengan kolam renang pribadi, taman luas, dan garasi untuk 2 mobil. Lokasi strategis dekat dengan pusat perbelanjaan dan sekolah internasional.', 2.5, 'miliar', 'rumah', 'jual', 4, 3, 200, 300, '00000000-0000-4000-0000-000000000001', '00000000-0000-4000-0000-000000000021', '00000000-0000-4000-0000-000000000050', 'Jl. Kemang Raya No. 10', '12730', ARRAY['Kolam Renang', 'Taman', 'Garasi', 'Keamanan 24 Jam', 'AC'], 'active', 120, 5, TRUE, NOW() - INTERVAL '30 days', NOW()),
  
  ('00000000-0000-4000-0000-000000000302', '00000000-0000-4000-0000-000000000104', 'Apartemen Studio di Pusat Kota Jakarta', 'Apartemen studio modern dengan pemandangan kota yang menakjubkan. Dilengkapi dengan fasilitas gym, kolam renang, dan area BBQ. Akses mudah ke transportasi umum.', 800, 'juta', 'apartemen', 'jual', 1, 1, 45, NULL, '00000000-0000-4000-0000-000000000001', '00000000-0000-4000-0000-000000000020', '00000000-0000-4000-0000-000000000048', 'Apartemen Central Park Tower A Unit 12F', '10730', ARRAY['Gym', 'Kolam Renang', 'Area BBQ', 'Keamanan 24 Jam', 'Parkir'], 'active', 85, 3, TRUE, NOW() - INTERVAL '25 days', NOW()),
  
  ('00000000-0000-4000-0000-000000000303', '00000000-0000-4000-0000-000000000107', 'Ruko 3 Lantai di Kawasan Bisnis Bandung', 'Ruko strategis 3 lantai di kawasan bisnis Bandung. Cocok untuk kantor, toko, atau restoran. Luas bangunan 150m² dengan 3 kamar mandi.', 1.8, 'miliar', 'ruko', 'jual', NULL, 3, 150, 50, '00000000-0000-4000-0000-000000000002', '00000000-0000-4000-0000-000000000025', '00000000-0000-4000-0000-000000000052', 'Jl. Pasir Kaliki No. 25', '40171', ARRAY['Listrik 3 Phase', 'Air PAM', 'Line Telepon', 'Parkir Luas'], 'active', 65, 2, FALSE, NOW() - INTERVAL '20 days', NOW()),
  
  ('00000000-0000-4000-0000-000000000304', '00000000-0000-4000-0000-000000000109', 'Tanah Kavling Siap Bangun di Bogor', 'Tanah kavling siap bangun dengan luas 200m². Lokasi strategis di kawasan berkembang Bogor. Cocok untuk rumah tinggal atau investasi.', 500, 'juta', 'tanah', 'jual', NULL, NULL, NULL, 200, '00000000-0000-4000-0000-000000000002', '00000000-0000-4000-0000-000000000026', '00000000-0000-4000-0000-000000000054', 'Jl. Raya Bogor KM 30', '16720', ARRAY['SHM', 'Listrik', 'Air PAM', 'Jalan Lebar'], 'active', 45, 1, FALSE, NOW() - INTERVAL '15 days', NOW()),
  
  ('00000000-0000-4000-0000-000000000305', '00000000-0000-4000-0000-000000000103', 'Rumah Minimalis di Depok', 'Rumah minimalis modern dengan 3 kamar tidur dan 2 kamar mandi. Desain terbuka dengan pencahayaan alami yang baik. Lokasi tenang dan nyaman.', 1.2, 'miliar', 'rumah', 'jual', 3, 2, 120, 150, '00000000-0000-4000-0000-000000000002', '00000000-0000-4000-0000-000000000027', '00000000-0000-4000-0000-000000000056', 'Jl. Margonda Raya No. 45', '16424', ARRAY['Carport', 'Taman', 'Listrik 2200 VA', 'Air PAM'], 'active', 78, 3, FALSE, NOW() - INTERVAL '10 days', NOW()),
  
  ('00000000-0000-4000-0000-000000000306', '00000000-0000-4000-0000-000000000104', 'Apartemen 2BR di Bekasi', 'Apartemen 2 kamar tidur dengan pemandangan kota. Lokasi strategis dekat dengan mall dan stasiun. Fasilitas lengkap dan keamanan 24 jam.', 650, 'juta', 'apartemen', 'jual', 2, 1, 65, NULL, '00000000-0000-4000-0000-000000000002', '00000000-0000-4000-0000-000000000028', '00000000-0000-4000-0000-000000000058', 'Apartemen Grand Bekasi Tower B Unit 15A', '17214', ARRAY['Kolam Renang', 'Gym', 'Taman Bermain', 'Jogging Track'], 'pending', 0, 0, FALSE, NOW() - INTERVAL '5 days', NOW()),
  
  ('00000000-0000-4000-0000-000000000307', '00000000-0000-4000-0000-000000000107', 'Kondominium Mewah di Surabaya', 'Kondominium mewah dengan pemandangan laut. Dilengkapi dengan fasilitas premium seperti jacuzzi, sauna, dan private lift. Keamanan 24 jam.', 3.5, 'miliar', 'kondominium', 'jual', 3, 3, 180, NULL, '00000000-0000-4000-0000-000000000004', '00000000-0000-4000-0000-000000000031', '00000000-0000-4000-0000-000000000064', 'The Peak Residence Tower A Unit PH-01', '60226', ARRAY['Private Lift', 'Jacuzzi', 'Sauna', 'Smart Home System', 'Balkon Luas'], 'active', 95, 4, TRUE, NOW() - INTERVAL '40 days', NOW()),
  
  ('00000000-0000-4000-0000-000000000308', '00000000-0000-4000-0000-000000000109', 'Gedung Komersial 4 Lantai di Semarang', 'Gedung komersial 4 lantai dengan luas bangunan 800m². Cocok untuk kantor, hotel, atau pusat bisnis. Lokasi strategis di pusat kota.', 15, 'miliar', 'gedung_komersial', 'jual', NULL, 8, 800, 400, '00000000-0000-4000-0000-000000000003', '00000000-0000-4000-0000-000000000029', '00000000-0000-4000-0000-000000000060', 'Jl. Pandanaran No. 15', '50241', ARRAY['Lift', 'Genset', 'Parkir Luas', 'CCTV', 'Fire Alarm System'], 'active', 60, 2, FALSE, NOW() - INTERVAL '35 days', NOW()),
  
  ('00000000-0000-4000-0000-000000000309', '00000000-0000-4000-0000-000000000103', 'Rumah Kost 15 Kamar di Yogyakarta', 'Rumah kost dengan 15 kamar yang sudah beroperasi. Lokasi strategis dekat kampus. Penghasilan pasif Rp 15 juta per bulan.', 2.2, 'miliar', 'rumah', 'jual', 15, 5, 250, 300, '00000000-0000-4000-0000-000000000003', '00000000-0000-4000-0000-000000000030', '00000000-0000-4000-0000-000000000062', 'Jl. Kaliurang KM 5 No. 10', '55281', ARRAY['Wifi', 'Dapur Bersama', 'Ruang Tamu', 'Parkir Motor', 'CCTV'], 'active', 88, 4, FALSE, NOW() - INTERVAL '28 days', NOW()),
  
  ('00000000-0000-4000-0000-000000000310', '00000000-0000-4000-0000-000000000104', 'Rumah Mewah di Bali', 'Villa mewah dengan pemandangan sawah dan laut. Desain modern dengan sentuhan Bali. Kolam renang infinity dan taman tropis.', 5, 'miliar', 'rumah', 'jual', 4, 5, 300, 500, '00000000-0000-4000-0000-000000000005', '00000000-0000-4000-0000-000000000033', '00000000-0000-4000-0000-000000000068', 'Jl. Sunset Road No. 88', '80361', ARRAY['Kolam Renang Infinity', 'Taman Tropis', 'Outdoor Jacuzzi', 'Gazebo', 'Smart Home'], 'active', 150, 8, TRUE, NOW() - INTERVAL '45 days', NOW()),
  
  ('00000000-0000-4000-0000-000000000311', '00000000-0000-4000-0000-000000000107', 'Apartemen Disewakan di Jakarta Pusat', 'Apartemen 2 kamar tidur fully furnished. Lokasi strategis di pusat kota. Tersedia untuk kontrak tahunan.', 15, 'juta', 'apartemen', 'sewa', 2, 1, 70, NULL, '00000000-0000-4000-0000-000000000001', '00000000-0000-4000-0000-000000000020', '00000000-0000-4000-0000-000000000048', 'Thamrin Residence Tower A Unit 12B', '10230', ARRAY['Fully Furnished', 'AC', 'Water Heater', 'TV', 'Kulkas'], 'active', 110, 6, TRUE, NOW() - INTERVAL '15 days', NOW()),
  
  ('00000000-0000-4000-0000-000000000312', '00000000-0000-4000-0000-000000000109', 'Ruko Disewakan di Bandung', 'Ruko 2 lantai di kawasan bisnis Bandung. Cocok untuk berbagai jenis usaha. Tersedia untuk kontrak minimal 2 tahun.', 25, 'juta', 'ruko', 'sewa', NULL, 2, 100, 50, '00000000-0000-4000-0000-000000000002', '00000000-0000-4000-0000-000000000025', '00000000-0000-4000-0000-000000000052', 'Jl. Braga No. 45', '40111', ARRAY['Listrik 3 Phase', 'Air PAM', 'Line Telepon', 'Parkir Depan'], 'active', 75, 3, FALSE, NOW() - INTERVAL '20 days', NOW()),
  
  ('00000000-0000-4000-0000-000000000313', '00000000-0000-4000-0000-000000000103', 'Rumah Kontrakan di Malang', 'Rumah nyaman dengan 3 kamar tidur. Lokasi tenang dan asri. Tersedia untuk kontrak tahunan.', 35, 'juta', 'rumah', 'sewa', 3, 2, 120, 150, '00000000-0000-4000-0000-000000000004', '00000000-0000-4000-0000-000000000032', '00000000-0000-4000-0000-000000000066', 'Jl. Soekarno Hatta No. 55', '65141', ARRAY['Carport', 'Taman', 'Pagar', 'Listrik 2200 VA'], 'active', 65, 2, FALSE, NOW() - INTERVAL '25 days', NOW()),
  
  ('00000000-0000-4000-0000-000000000314', '00000000-0000-4000-0000-000000000104', 'Gedung Kantor di Makassar', 'Gedung kantor 3 lantai dengan luas bangunan 500m². Lokasi strategis di pusat bisnis Makassar. Tersedia untuk kontrak minimal 3 tahun.', 150, 'juta', 'gedung_komersial', 'sewa', NULL, 6, 500, 300, '00000000-0000-4000-0000-000000000008', '00000000-0000-4000-0000-000000000036', '00000000-0000-4000-0000-000000000074', 'Jl. Pengayoman No. 12', '90231', ARRAY['Lift', 'Genset', 'Parkir Luas', 'CCTV', 'Ruang Meeting'], 'active', 55, 1, FALSE, NOW() - INTERVAL '30 days', NOW()),
  
  ('00000000-0000-4000-0000-000000000315', '00000000-0000-4000-0000-000000000107', 'Rumah Mewah di Jakarta Selatan', 'Rumah mewah dengan desain modern minimalis. Lokasi premium di kawasan elit Jakarta Selatan. Lingkungan aman dan nyaman.', 4.5, 'miliar', 'rumah', 'jual', 5, 5, 350, 450, '00000000-0000-4000-0000-000000000001', '00000000-0000-4000-0000-000000000021', '00000000-0000-4000-0000-000000000051', 'Jl. Senopati No. 15', '12110', ARRAY['Kolam Renang', 'Taman', 'Smart Home', 'Gym', 'Home Theater'], 'active', 130, 7, TRUE, NOW() - INTERVAL '18 days', NOW()),
  
  ('00000000-0000-4000-0000-000000000316', '00000000-0000-4000-0000-000000000109', 'Apartemen 3BR di Surabaya', 'Apartemen mewah 3 kamar tidur dengan pemandangan laut. Fasilitas premium dan lokasi strategis di pusat kota Surabaya.', 1.8, 'miliar', 'apartemen', 'jual', 3, 2, 120, NULL, '00000000-0000-4000-0000-000000000004', '00000000-0000-4000-0000-000000000031', '00000000-0000-4000-0000-000000000065', 'Ciputra World Residence Tower A Unit 25F', '60293', ARRAY['Kolam Renang', 'Gym', 'Sauna', 'Taman Bermain', 'Sky Lounge'], 'active', 95, 4, TRUE, NOW() - INTERVAL '22 days', NOW()),
  
  ('00000000-0000-4000-0000-000000000317', '00000000-0000-4000-0000-000000000103', 'Tanah Komersial di Denpasar', 'Tanah komersial strategis di jalan utama Denpasar. Cocok untuk hotel, mall, atau pusat bisnis. Luas 1000m² dengan akses mudah.', 10, 'miliar', 'tanah', 'jual', NULL, NULL, NULL, 1000, '00000000-0000-4000-0000-000000000005', '00000000-0000-4000-0000-000000000033', '00000000-0000-4000-0000-000000000069', 'Jl. Bypass Ngurah Rai No. 100', '80361', ARRAY['SHM', 'Jalan Lebar', 'Listrik', 'Air PAM'], 'active', 70, 2, FALSE, NOW() - INTERVAL '27 days', NOW()),
  
  ('00000000-0000-4000-0000-000000000318', '00000000-0000-4000-0000-000000000104', 'Rumah Kos Eksklusif di Yogyakarta', 'Rumah kos eksklusif dengan 20 kamar. Setiap kamar dilengkapi dengan kamar mandi dalam, AC, dan WiFi. Lokasi strategis dekat kampus.', 3.5, 'miliar', 'rumah', 'jual', 20, 20, 400, 500, '00000000-0000-4000-0000-000000000003', '00000000-0000-4000-0000-000000000030', '00000000-0000-4000-0000-000000000063', 'Jl. Affandi No. 25', '55281', ARRAY['Kamar Mandi Dalam', 'AC', 'WiFi', 'Dapur Bersama', 'Ruang Santai'], 'active', 85, 3, FALSE, NOW() - INTERVAL '32 days', NOW()),
  
  ('00000000-0000-4000-0000-000000000319', '00000000-0000-4000-0000-000000000107', 'Kondominium Mewah di Jakarta Utara', 'Kondominium mewah dengan pemandangan laut. Dilengkapi dengan fasilitas premium dan keamanan 24 jam. Akses mudah ke pusat kota.', 5.5, 'miliar', 'kondominium', 'jual', 4, 4, 250, NULL, '00000000-0000-4000-0000-000000000001', '00000000-0000-4000-0000-000000000024', '00000000-0000-4000-0000-000000000048', 'Regatta Tower Miami Unit PH-02', '14460', ARRAY['Private Lift', 'Jacuzzi', 'Smart Home', 'Wine Cellar', 'Balkon Luas'], 'active', 110, 5, TRUE, NOW() - INTERVAL '38 days', NOW()),
  
  ('00000000-0000-4000-0000-000000000320', '00000000-0000-4000-0000-000000000109', 'Ruang Kantor di Jakarta Pusat', 'Ruang kantor modern dengan luas 200m². Lokasi premium di gedung perkantoran kelas A. Tersedia untuk sewa jangka panjang.', 100, 'juta', 'gedung_komersial', 'sewa', NULL, 2, 200, NULL, '00000000-0000-4000-0000-000000000001', '00000000-0000-4000-0000-000000000020', '00000000-0000-4000-0000-000000000049', 'Menara Sudirman Lantai 15 Unit A', '10220', ARRAY['Furnished', 'Receptionist', 'Meeting Room', 'Pantry', 'Parking'], 'active', 75, 3, TRUE, NOW() - INTERVAL '12 days', NOW());
...
VALUES
  ('premium-monthly', 'Premium Listing', 29.99, 'USD', 30, 'Boost your property visibility with premium features', 
   ARRAY['Featured placement at top of search results', 'Golden highlighted border', 'Larger photo gallery (up to 20 images)', 'Extended listing duration (30 days)', 'Virtual tour integration', 'Detailed analytics dashboard', 'Priority customer support', 'Social media promotion'], 
  ...
  ('premium-quarterly', 'Premium Plus', 79.99, 'USD', 90, 'Extended premium visibility for serious sellers', 
   ARRAY['All Premium Listing features', 'Extended duration (90 days)', 'Featured in email newsletters', 'Premium badge on all listings', 'Highlighted in search results', 'Priority placement in similar properties', 'Dedicated account manager', 'Performance reports'], 
   TRUE, NOW() - INTERVAL '100 days', NOW()),
  ('premium-yearly', 'Premium Pro', 299.99, 'USD', 365, 'Maximum visibility for professional agents', 
   ARRAY['All Premium Plus features', 'Extended duration (365 days)', 'Featured on homepage', 'Professional photography service', 'Virtual tour creation', 'Social media marketing campaign', 'SEO optimization', 'Monthly performance reports'], 
   TRUE, NOW() - INTERVAL '100 days', NOW());
...
VALUES
  ...
  ('00000000-0000-4000-0000-000000000302', '00000000-0000-4000-0000-000000000112', 'Super Admin', 'UPDATE_SETTINGS', 'system_settings', '00000000-0000-4000-0000-000000001201', 'Updated system settings', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36', NOW() - INTERVAL '10 days'),
  ...
  ('00000000-0000-4000-0000-000000001309', '00000000-0000-4000-0000-000000000112', 'Super Admin', 'CREATE_PREMIUM_PLAN', 'premium_plans', 'premium-yearly', 'Created new premium plan', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36', NOW() - INTERVAL '100 days'),
  
  ('00000000-0000-4000-0000-000000001310', '00000000-0000-4000-0000-000000000111', 'Admin User', 'UPDATE_LOCATION', 'locations', '00000000-0000-4000-0000-000000000001', 'Updated location information', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36', NOW() - INTERVAL '12 days');
